...
async def next_page(bot, query):
    filesc = await Media.count_documents()
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
            text=script.LYI_TXT.format(query.from_user.mention),
            reply_markup=reply_markup,
            parse_mode='html'
        )
    elif query.data == "tor":
        ...
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
            text=script.TOR_TXT.format(query.from_user.mention),
            reply_markup=reply_markup,
            parse_mode='html'
        )
        ...
        if settings is not None:
            buttons = [
               ...
               [
                ...
                [
                    InlineKeyboardButton('𝚂𝙴𝚃 𝚆𝙴𝙻𝙲𝙾𝙼𝙴', callback_data=f'setgs#welcome#{settings["welcome"]}#{str(grp_id)}'),
