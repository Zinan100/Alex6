...
async def gen_link_batch(bot, message):
    ...
    if chat_id in FILE_STORE_CHANNEL:
        ...
        return await sts.edit(f"<b>⪼ ʜᴇʀᴇ ɪs ʏᴏᴜʀ ʟɪɴᴋ ››  https://t.me/{temp.U_NAME}?start=DSTORE-{b_64}</b>")
    ...
    await sts.edit(f"<b>⪼ ʜᴇʀᴇ ɪs ʏᴏᴜʀ ʟɪ\nᴄᴏɴᴛᴀɪɴs `{og_msg}` ғɪʟᴇs.</b>\n\n<b>›› https://t.me/{temp.U_NAME}?start=BATCH-{file_id}</b>", disable_web_page_preview=True)
